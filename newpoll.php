...
<form name="register">
    <fieldset>
      ...
      <div class="form-group">
        ...
        <input name="start" type="password" class="form-control" id="passwd" placeholder="Password">
      </div>
      <div class="form-group">
        <label for="stop" class="form-label mt-4">Stop</label>
        <input name="stop" type="password" class="form-control" id="confirm" placeholder="Password">
      </div>
